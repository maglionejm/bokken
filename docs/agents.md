...
| Skeptic persona (panel role `skeptic`, journaled under its own cast name) | `challenge` → `claude-fable-5` | Mandatory on-record challenge before convergence closes | Be skipped; challenge people instead of claims |
